...
ref("So I'm on 27", "Psalms", 127, 1);
ref("so im on 27", "Psalms", 127, 1);
ref("so im on twenty seven", "Psalms", 127, 1);
ref("so im on one twenty seven", "Psalms", 127, 1);
ref("so im twenty three", "Psalms", 23, 1);
ref("John three sixteen", "John", 3, 16);
ref("John three sixteen please", "John", 3, 16);
...
fail("John loved the world");
fail("Romans all things work together");
fail("so im on john three");
fail("so im john three");
fail("John 99");
fail("John 3 16 17");
